...
**Null Hypothesis:** population mean = sample mean (population mean of suspension coil psi is **not statistically different** from the sample mean)\
**Alternative Hypothesis:** population mean ≠ sample mean (population mean of suspension coil psi is **statistically different** from the sample mean)
